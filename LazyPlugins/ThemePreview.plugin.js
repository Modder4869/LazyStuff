...
class ThemePreview{
	...
	getDescription(){
		return 'Preview themes posted in #Theme-repo and styles in codeblocks, allows you to preview linked or uploaded stylesheet files including [https://betterdiscord.net/ghdl?id=] links using the context menu.';
	}
	getVersion(){
		return '0.0.5';
	}
